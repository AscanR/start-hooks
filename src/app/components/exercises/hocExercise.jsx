...
import SimpleButton from "../common/typografy/simpleButton";
import WithFunctions from "./hoc/withFunctions";

const HocExercise = () => {
    const ButtonWithAuth = SimpleComponent(SimpleButton);
    const ButtonWithFunctions = WithFunctions(ButtonWithAuth);
    return (
